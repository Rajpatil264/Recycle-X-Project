...
import signupImage from "../../assets/images/ConsumerRegisterPage.jpg";
...
const ConsumerRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            try {
                const response = await axios.post("http://localhost:5000/consumer/signup", {
                    firstName,
                    lastName,
                    email,
                    mobileNumber,
                ...
                if (response.data.status === "success") {
                    ...
                    navigate("/consumer/otp-verification", { state: { email } });
                } else {
            ...
            <div className={styles.formSide}>
                ...
                <form onSubmit={handleSubmit} className={styles.signupForm}>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className={`${styles.input} ${errors.email ? styles.error : ''}`} />
                    ...
                    <div className={styles.pincodeAndTypeFields}>
                        ...
                        <div className={styles.inputGroup}>
                            <label htmlFor="consumerType">Consumer Type</label>
                            <select id="consumerType" value={consumerType} onChange={(e) => setConsumerType(e.target.value)} className={styles.input}>
                    ...
                    <p className={styles.loginLink}>
                        Already have an account? <Link to="/consumer/login">Login</Link>
                    </p>
                </form>
            </div>
        </div>
